...
https://github.com/getreu/legacy-to-uefi-boot[Github].  There you can file
https://github.com/getreu/legacy-to-uefi-boot/issues[issues] and
https://github.com/getreu/legacy-to-uefi-boot/pulls[pull requests].
...
`2` and the partition code `EF00` (or `EF02`).
